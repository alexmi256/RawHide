# Panasonic DC-FZ80
Profile slug: `panasonic_dc_fz80`  
EXIF Make/Model: `Panasonic` / `DC-FZ80`
...
Representative file: `Panasonic Lumix DMC-FZ80/0388864419.rw2`
Files seen: 2 (Panasonic Lumix DMC-FZ80/0388864419.rw2, Panasonic Lumix DMC-FZ80/0858700542.rw2)
Software strings observed: Ver.1.0
Lenses observed: none
ISO observed: 80
Exposure observed: 1/400 s, 1/800 s
F-number observed: F2.8, F5.6
Focal length observed: 3.6 mm, 58.9 mm
Serial tags present: none (generic fallback (no serial tags observed))

## Static fields (identical in every output file)
- Make `Panasonic`, Model `DC-FZ80`, UniqueCameraModel `DC-FZ80`, Software `Ver.1.0`
...
- Lens pool (1): DC-FZ80 built-in lens
- FocalLength + 35mm equivalent (x2.7), Metering [2, 3, 5], ExposureProgram [1, 2, 3, 4]
- Camera/lens serials (prefixes ['1A', '4E', '7B', 'C2']), ImageNumber, AsShotNeutral, BaselineExposure, Brightness, ExposureBias

## Sub-profiles
- `panasonic_dc_fz80-native`: pins 4912x3688 (native sensor geometry)

Base `--camera-profile=panasonic_dc_fz80` auto-sizes like the default profile but stamps this camera's Make/Model/lenses.
