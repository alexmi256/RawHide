# Leica M10-P
Profile slug: `leica_m10_p`  
EXIF Make/Model: `Leica Camera AG` / `LEICA M10-P`
...
Representative file: `Leica M10-P/2943228913.dng`
Files seen: 2 (Leica M10-P/2943228913.dng, Leica M10-P/7003128956.dng)
Software strings observed: 2.4.5.2
Lenses observed: Elmarit-M 1:2.8/28 ASPH.; Summicron-M 1:2/35 ASPH.
ISO observed: 200
Exposure observed: 1/1000 s, 1/750 s
F-number observed: F3.4
Focal length observed: 28.0 mm, 35.0 mm
...
- IFD0 AsShotNeutral: [256, 516, 256, 256, 256, 334]
...
- raw UniqueCameraModel: "LEICA M10-P"
- raw _shape: [3992, 5984]
- raw _dtype: "uint16"
- raw _photometric: 32803

## Static fields (identical in every output file)
- Make `Leica Camera AG`, Model `LEICA M10-P`, UniqueCameraModel `LEICA M10-P`, Software `2.4.5.2`
...
- ExposureTime pool: [[1, 1000], [10, 8000], [1, 750], [10, 4000], [10, 2000], [10, 1000], [10, 500], [10, 250], [10, 125], [10, 60], [10, 30], [10, 21], [10, 17], [10, 16], [10, 8], [15, 10], [10, 5], [20, 10], [10, 4], [30, 10], [10, 3], [50, 10], [10, 2], [60, 10], [10, 1]]
...
- Lens pool (2): Elmarit-M 1:2.8/28 ASPH.; Summicron-M 1:2/35 ASPH.
...
## Sub-profiles
- `leica_m10_p-native`: pins 5976x3984 (native sensor geometry)

Base `--camera-profile=leica_m10_p` auto-sizes like the default profile but stamps this camera's Make/Model/lenses.
