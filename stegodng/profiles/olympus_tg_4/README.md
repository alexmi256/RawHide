# Olympus TG-4
Profile slug: `olympus_tg_4`  
EXIF Make/Model: `OLYMPUS CORPORATION` / `TG-4`
...
Representative file: `Olympus TG-4 real-world/6470743291.orf`
Files seen: 2 (Olympus TG-4 real-world/6470743291.orf, Olympus TG-4 real-world/7716099950.orf)
Software strings observed: Version 1.0
Lenses observed: none
ISO observed: 100
Exposure observed: 1/1000 s, 1/500 s
F-number observed: F2.8, F4
Focal length observed: 4.5 mm, 7.3 mm
Serial tags present: none (generic fallback (no serial tags observed))

## Static fields (identical in every output file)
- Make `OLYMPUS CORPORATION`, Model `TG-4`, UniqueCameraModel `TG-4`, Software `Version 1.0`
...
- Lens pool (1): TG-4 built-in lens
- FocalLength + 35mm equivalent (x2.7), Metering [2, 3, 5], ExposureProgram [1, 2, 3, 4]
- Camera/lens serials (prefixes ['1A', '4E', '7B', 'C2']), ImageNumber, AsShotNeutral, BaselineExposure, Brightness, ExposureBias

## Sub-profiles
- `olympus_tg_4-native`: pins 4624x3472 (native sensor geometry)

Base `--camera-profile=olympus_tg_4` auto-sizes like the default profile but stamps this camera's Make/Model/lenses.
