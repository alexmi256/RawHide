# Leica Q3
Profile slug: `leica_q3`  
EXIF Make/Model: `LEICA CAMERA AG` / `LEICA Q3`
...
Representative file: `Leica Q3/0884401829.dng`
Files seen: 2 (Leica Q3/0884401829.dng, Leica Q3/7858115920.dng)
Software strings observed: 0.5.12-t
Lenses observed: SUMMILUX 1:1.7/28 ASPH.
ISO observed: 2500, 640
Exposure observed: 1/50 s
F-number observed: F1.7, F2.8
...
- IFD0 UniqueCameraModel: "LEICA Q3"
...
- raw RawDataUniqueID: {"hex": "68020918070801e7071b235700000000"}
- raw ActiveArea: [0, 0, 6344, 9536]
- raw OpcodeList3: {"hex": "00000001000000010103000000000000000000a4000000033feffdfd0e4cb19fbfadc40a8509a94dbfb46fcb36825bbc3fa6e8172b8723b8000000000000000000000000000000003feff9f
...
- Make `LEICA CAMERA AG`, Model `LEICA Q3`, UniqueCameraModel `LEICA Q3`, Software `0.5.12-t`
...
- ExposureTime pool: [[10, 8000], [10, 4000], [10, 2000], [10, 1000], [10, 500], [1, 50], [10, 250], [10, 125], [10, 60], [10, 30], [10, 21], [10, 17], [10, 16], [10, 8], [15, 10], [10, 5], [20, 10], [10, 4], [30, 10], [10, 3], [50, 10], [10, 2], [60, 10], [10, 1]]
...
- Camera/lens serials (prefixes ['57']), ImageNumber, AsShotNeutral, BaselineExposure, Brightness, ExposureBias

## Sub-profiles
- `leica_q3-native`: pins 9520x6336 (native sensor geometry)

Base `--camera-profile=leica_q3` auto-sizes like the default profile but stamps this camera's Make/Model/lenses.
